...
// L298N H-Bridge Connection PINs (Adapted to your configurations)
#define L298N_enA 27  // PWM
#define L298N_enB 26  // PWM
#define L298N_in4 25  // Dir Motor B
#define L298N_in3 33  // Dir Motor B
#define L298N_in2 13  // Dir Motor A
#define L298N_in1 14  // Dir Motor A

// Wheel Encoders Connection PINs (Adapted to your configurations)
#define right_encoder_phaseA 16  // Interrupt
#define right_encoder_phaseB 19  
#define left_encoder_phaseA 23   // Interrupt
#define left_encoder_phaseB 17
